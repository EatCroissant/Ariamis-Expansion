...
public class TileEntityRendererGrindstone extends TileEntitySpecialRenderer {
    ...
    public TileEntityRendererGrindstone()
    {
        ...
        textureBase = new ResourceLocation(Ariamis.MODID,  "textures/mod/grindstoneBase.png");
        textureStone = new ResourceLocation(Ariamis.MODID,  "textures/mod/grindstoneStone.png");
    }
