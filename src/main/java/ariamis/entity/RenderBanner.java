...
public class RenderBanner extends Render
{
    ...
    public RenderBanner()
    {
        textureBannerSmall = new ResourceLocation(Ariamis.MODID,  "textures/mod/bannersSmall.png");
        textureBannerLarge = new ResourceLocation(Ariamis.MODID,  "textures/mod/bannersLarge.png");
    }
