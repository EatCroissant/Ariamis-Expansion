...
//        }
    ...
    {
        if (getSize() == 0) worldObj.spawnEntityInWorld(new EntityItem(worldObj, posX, posY, posZ, new ItemStack(ItemRegistry.bannerSmall, 1, getColor())));

        else if (getSize() == 2) worldObj.spawnEntityInWorld(new EntityItem(worldObj, posX, posY, posZ, new ItemStack(ItemRegistry.bannerLarge, 1, getColor())));

        else worldObj.spawnEntityInWorld(new EntityItem(worldObj, posX, posY, posZ, new ItemStack(ItemRegistry.bannerSmall, 1, getColor())));
    }
